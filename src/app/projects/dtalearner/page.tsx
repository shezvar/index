            ...
            <div className="flex flex-col">
              ...
              <div className="mb-4">
                ...
                <div className="mb-12 flex flex-col gap-16">
                  <Image
                    src="/assets/dtalearner/dta-persona.png"
                    alt="Learner Persona"
                    width={1000}
                    height={1000}
                  />
                  <Image
                    src="/assets/dtalearner/dta-journey.png"
                ...
                <div className="border-l-2 border-green-500 pl-4">
                  ...
                  <ul className="*:mb-3">
                    <li>
                      <strong>Learner Persona</strong> – Three primary learner
                      types were identified: Beginners (new to digital skills),
                      Intermediate (some experience), and Advanced (seeking
                      certification). Each group required different levels of
                      support and guidance.
                    </li>
                    <li>
                      <strong>Accessibility Challenges</strong> – Many learners
                      had limited internet access and varying device types. The
                      platform needed to work seamlessly across mobile, tablet,
                      and desktop with offline capabilities.
                    </li>
                    <li>
                      <strong>Motivation Factors</strong> – Learners needed
                      clear progress indicators, peer comparison, and regular
                      feedback to stay engaged. Visual progress tracking and
                      achievement systems were crucial for retention.
                    </li>
                    <li>
                      <strong>Support Requirements</strong> – Direct access to
                      facilitators and mentors was essential for learner
                      success. In-app messaging and scheduled support sessions
                      were highly valued.
                    </li>
                  </ul>
                </div>
        ...
        <section className="border-x border-b border-stone-200 w-full px-6 lg:px-56 pt-16 pb-12 flex flex-row gap-0 h-min justify-center max-w-6xl mx-auto relative">
          <div className="w-full flex flex-row justify-start relative">
            <div className="flex flex-col">
              ...
              >
                <div className="">
                  85% learner engagement rate across all courses
                </div>
                <div className="">
                  92% completion rate for personalized learning pathways
                </div>
                <div className="">
                  78% of learners achieved certification within target timeframe
                </div>
                <div className="">
                  95% satisfaction rate with platform usability and support
                </div>
              </Card>
              <p className="mt-4">
                These outcomes demonstrate how a thoughtfully researched and
                well-designed digital platform can transform education and
                create meaningful career opportunities for thousands of
                Nigerians.
              </p>
            </div>
          </div>
